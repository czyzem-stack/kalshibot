...
class EnvSettings:
    ...
    # Breeder Lab Hive lines (council_reply, strategic_pulse, …): default DEBUG to avoid flooding INFO (set LOG_LEVEL=DEBUG to see).
    # Set LAB_THINK_TANK_LOG_INFO=1 to log each line at INFO again.
